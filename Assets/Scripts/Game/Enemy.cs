...
public class Enemy : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
         ...
         */
         ...
         UnityEngine.Vector3 vectorToPlayer = playerPosition - enemyPosition;

         mRigidBody.MovePosition(enemyPosition + vectorToPlayer * speed * Time.deltaTime);
    }
    ...
    private void SetupCollider()
    {
        ...
        mBoxCollider.center = new UnityEngine.Vector3 {
            x = colliderCenter.x,
            y = colliderCenter.y, 
            z = transform.localScale.y, 
        };
        var colliderSize = mBoxCollider.size;
        mBoxCollider.size = new UnityEngine.Vector3 {
            x = colliderSize.x,
            y = colliderSize.y, 
